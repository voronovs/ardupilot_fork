...
gcs:send_text(7, string.format("FW version - ANT24X9PCO_4.5.7.3")) -- вставить название полетного контроллера
gcs:send_text(7, string.format("ARS version - NONE"))
gcs:send_text(7, string.format("Parameters version - 20250924"))
gcs:send_text(7, string.format("Script version - 20250924"))
